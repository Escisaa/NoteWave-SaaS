...
import { getStripeSession, stripe } from "@/app/lip/stripe";
...
export default async function BillingPage() {
  ...
  async function creatSubscription() {
    "use server";
      ...
      <Card className="flex flex-col">
        <CardContent className="py-8">
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            Write waht you want under the pricing tag
          </p>
        </CardContent>
        <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-secondary rounded-lg m-1 space-y-6 sm:pt-6">
          ...
          <form className="w-full" action={creatSubscription}>
            <StripeSubscriptionCreationButton />
          </form>
        </div>
      </Card>
